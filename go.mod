...
require (
	github.com/0xPolygonID/go-circuit-external v0.0.8
...
require (
	...
	github.com/iden3/contracts-abi/onchain-non-merklized-issuer-base/v0/go/abi v0.0.0-20250731122317-bfb79ac13225 // indirect
